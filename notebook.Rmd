...
# Prepare color vector for names
namesVectorColor = c()
for (n in attributes_xlsx$ID) {
  if (n == "Sara") {
    namesVectorColor = append(namesVectorColor, "#F9A03F")
  } else if (n == "Francesco"){
    namesVectorColor = append(namesVectorColor, "#CA1551")
  } else {
    namesVectorColor = append(namesVectorColor, "#59A5D8")
  }
}
